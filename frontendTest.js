...
var url = 'http://my.domain.url/';
var sec_url = 'https://my.domain.url/';
...
var payment = Math.floor(Math.random() * (this.PAYMENT_CASHONDELIVERY - this.PAYMENT_CHECKMO + 1)) + min;PAYMENT_CHECKMO; 
